...
import { checkCiWorkflow, checkPrettier, checkPackage, checkTests, checkActionYml, checkFilesystem, checkManifest, skippedChecks, } from "./checks/index.js";
const VERSION = "1.0.0";
const CHECK_GROUPS = [
...
export function runLint(cwd) {
    ...
    const groups = CHECK_GROUPS.map((mod) => ({
        id: mod.id,
        label: mod.label,
        checks: mod.fn(ctx),
    }));
